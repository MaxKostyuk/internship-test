...
import com.kostyuk.api.models.UserRegistration;
import com.kostyuk.api.models.UserRegistrationResponse;
...
public class CreateUser extends BaseRequest {
    ...
    public static void checkSuccessfulUserRegistrationResponse(Response response) {
        UserRegistrationResponse responseObject = Assertions.assertDoesNotThrow(() -> fromJson(response.asString(), UserRegistrationResponse.class), "Response has unexpected structure");
